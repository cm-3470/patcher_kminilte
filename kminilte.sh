...
git fetch https://github.com/cm-gardalte/android_frameworks_av.git cm-12.1
...
git fetch https://github.com/cm-gardalte/android_frameworks_native.git cm-12.1
...
#git fetch https://github.com/cm-gardalte/android_frameworks_base.git cm-12.1
